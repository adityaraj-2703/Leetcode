...
public class Client {
    public static void main(String[] args) {
        ...
        CricInfoSystem c = new CricInfoSystem();

        String scorecardId = "SC-M001-0001";

        Scorecard sc = c.getScoreCard(scorecardId);

        c.updateScoreCard(scorecardId, "T1", 100);
        c.updateScoreCard(scorecardId, "T2", 75);
        ...
        c.addInnings(scorecardId, innings1);
        c.addInnings(scorecardId, innings2);

        Scorecard updatedScorecard = c.getScoreCard(scorecardId);
